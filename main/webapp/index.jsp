      ...
      <div class="header-container">
         <nav class="header-nav-bar">
				...
				<ul class="header-nav-lists">
						...
						<li class="header-nav-list">
							<a class="header-nav-link header-active" href="adminlogin">Admin</a>
						</li>
						<li class="header-nav-list">
							<a class="header-nav-link header-active" href="emplogin">Employee</a>
						</li>
					<li class="header-nav-list">
			...
			<nav class="footer-nav">
				...
				<div class="footer-contact-us">
					...
					<p class="footer-description-detail">
						...
						<span>Hi-Tech city,Hyderabad</span></p>
					<p class="footer-description-detail">
					...
					<p class="footer-description-detail">
						...
						<span>starhotels@gmail.com</span> </p>
				</div>
				<div class="footer-follow-us">
					<h3 class="footer-description-title">Follow Us</h3>
					<ul class="footer-follow-us-lists">
						<li class="follow-us-list">
							<a href="https://twitter.com/MeghanathG">
						...
						<li class="follow-us-list">
							<a href="https://www.instagram.com/meghanathreddygogireddy/?next=%2F&hl=en">
